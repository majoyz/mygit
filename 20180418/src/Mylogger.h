...
public:
	...
	void error(const char * msg, Args&&...args){
		_root.error(msg, std::forward<Args>(args)...);
	}

	void warn(const char * msg);
	template <typename... Args>
	void warn(const char * msg, Args...args){
		_root.warn(msg, std::forward<Args>(args)...);
		//_root.warn(msg, args...);
	}
	...
	void info(const char * msg, Args&&...args){
		_root.info(msg, std::forward<Args>(args)...);
	}

	void debug(const char * msg);
	template <typename... Args>
	void debug(const char * msg, Args&&...args){
		_root.debug(msg, std::forward<Args>(args)...);
	}
...
#define LogWarn(msg, ...)  Mylogger::getInstance()->warn(prefix(msg), ##___VA_ARGS__)
